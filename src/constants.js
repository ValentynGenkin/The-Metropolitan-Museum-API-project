...
export const HOME_BTN = 'home-btn';
export const SEARCH_BTN = 'search-btn';
export const DEPARTMENTS_BTN = 'departments-btn';
export const NEXT_PAGE_BTN = 'next-page-btn';
export const PREVIOUS_PAGE_BTN = 'previous-page-bnt';
export const NAVIGATION_BTN = 'navigation-btn';
export const DEPARTMENT_CONTAINER = 'dep-container';
export const DEPARTMENT_PAGE = 'department-page';
export const SEARCH_INPUT = 'search-input';
export const ITEM_ELEMENT = 'item-element';
export const SEARCH_ELEMENT = 'search-element';
export const FILTER_BTN = 'filter-btn';
